<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (auth()->user()->hasRole('Admin'))
                        ...
                        <x-nav-link :href="route('permission.index')" :active="request()->routeIs('permission.index', 'permission.create', 'permission.edit')">
                            {{ __('Permisos') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('editor.post.index')
                <x-responsive-nav-link :href="route('post.index')" :active="request()->routeIs('post.index', 'post.create', 'post.edit')">
                    {{ __('Post') }}
                </x-responsive-nav-link>
            @endcan
            @can('editor.category.index')
            ...
            @endcan
            @if (auth()->user()->hasRole('Admin'))
                <x-responsive-nav-link :href="route('role.index')" :active="request()->routeIs('role.index', 'role.create', 'role.edit')">
                    {{ __('Roles') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('permission.index')" :active="request()->routeIs('permission.index', 'permission.create', 'permission.edit')">
                    {{ __('Permisos') }}
                </x-responsive-nav-link>
            @endif
            @can('editor.user.index')
